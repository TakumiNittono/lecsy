    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-md mx-auto px-5 pt-12 pb-24">
        <div className="text-center mb-8">
          <div className="inline-flex w-20 h-20 mb-5 rounded-2xl bg-gray-900 text-white items-center justify-center shadow-sm">
        ...
        <Suspense fallback={<div className="h-48 rounded-2xl bg-gray-100" />}>
          <InviteCodeForm />
        </Suspense>
        ...
        <div className="mt-10 text-center text-sm text-gray-500">
          Don&apos;t have a code?{" "}
          <Link href="/support" className="text-gray-900 hover:underline underline-offset-2">
            Ask your teacher
          </Link>
        </div>

        <div className="mt-8 p-5 rounded-2xl bg-gray-50 border border-gray-200 text-xs text-gray-600 leading-relaxed">
          ...
          <p>
            ...
            <Link href="/privacy" className="text-gray-900 hover:underline underline-offset-2">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </main>
